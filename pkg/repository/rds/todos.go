...
type Todo struct {
	...
	Todo      string    `boil:"todo" json:"todo" toml:"todo" yaml:"todo"`
...
var TodoWhere = struct {
	...
	Todo:      whereHelperstring{field: "`todos`.`todo`"},
	Finished:  whereHelperbool{field: "`todos`.`finished`"},
...
var (
	todoAllColumns            = []string{"id", "todo", "finished", "user_id", "created_at", "updated_at"}
	todoColumnsWithoutDefault = []string{"todo", "user_id"}
	todoColumnsWithDefault    = []string{"id", "finished", "created_at", "updated_at"}
...
func (q todoQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Todo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "rds: failed to execute a one query for todos")
	}
...
func (q todoQuery) All(ctx context.Context, exec boil.ContextExecutor) (TodoSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "rds: failed to assign all query results to Todo slice")
	}
...
func (q todoQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rds: failed to count todos rows")
	}
...
func (q todoQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "rds: failed to check if todos exists")
	}
...
func FindTodo(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Todo, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "rds: unable to select from todos")
	}
...
func (o *Todo) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("rds: no todos provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "rds: unable to insert into todos")
	}
	...
	if err != nil {
		return errors.Wrap(err, "rds: unable to populate default values for todos")
	}
...
func (o *Todo) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("rds: unable to update todos, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to update todos row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rds: failed to get rows affected by update for todos")
	}
...
func (q todoQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to update all for todos")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to retrieve rows affected for todos")
	}
...
func (o TodoSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("rds: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to update all in todo slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to retrieve rows affected all in update all todo")
	}
	return rowsAff, nil
}
...
func (o *Todo) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("rds: no todos provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("rds: unable to upsert todos, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "rds: unable to upsert for todos")
	}
	...
	if err != nil {
		return errors.Wrap(err, "rds: unable to retrieve unique values for todos")
	}
...
func (o *Todo) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("rds: no Todo provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to delete from todos")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rds: failed to get rows affected by delete for todos")
	}
...
func (q todoQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("rds: no todoQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to delete all from todos")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "rds: failed to get rows affected by deleteall for todos")
	}
...
func (o TodoSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "rds: unable to delete all from todo slice")
	}
...
func (o *TodoSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "rds: unable to reload all in TodoSlice")
	}
...
func TodoExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "rds: unable to check if todos exists")
	}
